...
[packages/functions/src/oidc/aws-credentials-provider.ts:70](https://github.com/Alfaesal23/vercel/blob/main/packages/functions/src/oidc/aws-credentials-provider.ts#L70)
