...
Defined in: [packages/oidc/src/get-vercel-oidc-token-with-refresh.ts:96](https://github.com/Alfaesal23/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token-with-refresh.ts#L96)
