...
Defined in: [packages/oidc/src/get-vercel-oidc-token-sync.ts:25](https://github.com/Alfaesal23/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token-sync.ts#L25)
